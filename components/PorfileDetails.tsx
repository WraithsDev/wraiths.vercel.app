      ...
      <div className='avatar'>
        {discord ? (
          ...
          <div className={'w-36 rounded-full mb-4 md:mb-0 ring ring-primary ring-offset-base-100 ring-offset-2'}>
            <Image className='rounded-full hover:opacity-75 transition duration-700' src={'https://media.tenor.com/fVoHRPRIetUAAAAi/chipi-chipi-chapa-chapa-chipi.gif'} alt='avatar' width={1024} height={1024} />
          </div>
        )}
      </div>
    </div>
